...
// tag::personrole[]
=== Client and vet technician role

==== Reasons for implementation

VetterAppointments requires to manage clients and vet technicians in the application. The implementation will allow the application to differentiate the different persons in VetterAppointments with two different types of roles specifically the client and vet technician.

==== Current implementation todo

The two different types of roles in VetterAppointments
...
Figure 4-17 shows the sequence diagram of how the autocomplete operation works.

.AutoComplete Sequence Diagram
image::AutoCompleteSequenceDiagram.png[width="800", caption="Figure 4-17. "]
